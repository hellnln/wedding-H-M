        ...
        <article className="logement__box">
          ...
          <ul className="logement__mainTextBox">
            <li className="logement__listBox">
              ...
              <h4 className='logement__textTitle'>En camping-car</h4>
              ...
              <p className="logement__text">Vous pourrez garer votre véhicule sur le parking du gîte.</p>
            </li>
            <li className="logement__listBox">
              <div className='logement__textBox'>
              <h4 className='logement__textTitle'>Sous la tente</h4>
              <button className='btn__reservation'><Link to='/reservation' className='btn__link'>Réserver</Link></button>
              {/* <FontAwesomeIcon icon="tent" className="logement__text" />  */}
              
              </div>
              <p className="logement__text">Vous pourrez planter votre tente sur le terrain du gîte</p>
             </li>
          </ul>
        </article>
